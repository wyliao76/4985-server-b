...
files_to_copy=(".clang-format" ".gitignore" "build.sh" "build-all.sh" "change-compiler.sh" "check-compilers.sh" "check-env.sh" "files.txt" "generate-cmakelists.sh" "generate-flags.sh" "move.sh" "link-flags.sh" "README.md" "src" "include" "tests")
